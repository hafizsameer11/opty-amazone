...
class WarehouseOrder extends Model
{
    ...
    protected $fillable = ['order_number', 'idempotency_key', 'seller_id', 'store_id', 'status', 'payment_status', 'subtotal', 'shipping_fee', 'total', 'seller_wallet_entry_id', 'tracking_number', 'shipping_carrier', 'shipping_notes', 'shipping_address', 'paid_at', 'cancelled_at', 'delivered_at'];
