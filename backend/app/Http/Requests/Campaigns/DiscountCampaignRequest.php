...
class DiscountCampaignRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'starts_at'=>'required|date', 'ends_at'=>'required|date|after:starts_at', 'schedule_timezone'=>'sometimes|string|max:64|timezone', 'launch_mode'=>'sometimes|in:run_now,schedule', 'status'=>'sometimes|in:draft,scheduled',
