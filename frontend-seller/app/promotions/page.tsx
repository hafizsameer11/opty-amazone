...
export default function CampaignPage() {
 ...
 return <div className="min-h-screen bg-gray-50 flex"><Sidebar /><div className="flex-1 min-w-0"><Header /><main className="max-w-7xl mx-auto p-6 pb-24"><CampaignManager kind="discount" /></main><BottomNav /></div></div>;
}
