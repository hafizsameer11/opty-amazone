...
export default function EditAccessoriProductPage() {
  ...
  if (pageLoading || !formData) {
    return (
      <ProductEditShell title="Edit accessory" subtitle="Loading…">
  ...
  return (
    <ProductEditShell
      ...
      subtitle="Same simplified layout as create: basics, pricing, images, and accessory options."
    >
      {error ? (
        <div className="mb-4">
