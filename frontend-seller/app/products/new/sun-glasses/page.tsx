...
export default function SunGlassesProductPage() {
  ...
  const loadCategories = async () => {
    try {
      ...
      const sunGlassesCategory = data.find(cat => cat.slug === 'sun-glasses');
      if (sunGlassesCategory) {
        setCategoryId(sunGlassesCategory.id);
        setFormData(prev => ({ ...prev, category_id: sunGlassesCategory.id }));
        await loadFieldConfig(sunGlassesCategory.id);
      }
    } catch (error) {
            ...
            <div className="py-6">
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-6">
                  ...
                  <h1 className="text-3xl font-bold text-gray-900">Create Sun Glasses Product</h1>
                </div>
