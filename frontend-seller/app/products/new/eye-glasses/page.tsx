...
export default function EyeGlassesProductPage() {
  ...
  const loadCategories = async () => {
    try {
      ...
      // Find eye-glasses category
      const eyeGlassesCategory = data.find(cat => cat.slug === 'eye-glasses');
            ...
            <div className="py-6">
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="mb-6">
                  ...
                  <h1 className="text-3xl font-bold text-gray-900">Create Eye Glasses Product</h1>
                </div>
